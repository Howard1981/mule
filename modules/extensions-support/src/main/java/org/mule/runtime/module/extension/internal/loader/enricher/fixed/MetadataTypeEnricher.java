...
class MetadataTypeEnricher {
  ...
  private class TypeEnricherVisitor extends MetadataTypeVisitor {
    ...
    private <T extends TypeBuilder & WithAnnotation> MetadataType withNewAnnotations(T builder) {
      HashSet<TypeAnnotation> all = getAllTypeAnnotations();
    ...
    private HashSet<TypeAnnotation> getAllTypeAnnotations() {
      HashSet<TypeAnnotation> all = new HashSet<>(annotations);
